...
import { ConfigManagers } from "./ConfigManagers";
import { EventHandlers } from "./EventHanlders";
import { Logger } from "./Logger";
import { PluginManagers } from "./PluginManagers";
import { SettingMenuBuilders } from "./SettingMenuBuilders";
import type { SystemBaseOptions } from "../types/SystemBaseOptions";
import type { WorldEvents } from "../types/WorldEvents";
import { PlayerManagers } from "./PlayerManagers";
...
class SystemBase {
  ...
  private subscribeToEvent(eventName: string) {
    ...
    const lowerEventName =
      baseEventName.charAt(0).toLowerCase() + baseEventName.slice(1);
